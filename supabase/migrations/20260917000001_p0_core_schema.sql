...
-- Description: Core Production Schema for AstroFindings P0 Core MVP
...
CREATE TABLE IF NOT EXISTS public.profiles (
  ...
  birth_date DATE,
  birth_time TIME,
  is_birth_time_approximate BOOLEAN DEFAULT FALSE,
...
CREATE TABLE IF NOT EXISTS public.subscriptions (
  ...
  provider_customer_id TEXT NOT NULL DEFAULT 'dodo_cust_pending',
  provider_subscription_id TEXT UNIQUE,
  provider_product_id TEXT NOT NULL DEFAULT 'free_tier',
...
EXCEPTION WHEN duplicate_object THEN null; END 64518;
...
BEGIN
  ...
  RETURN NEW;
END;
64518 LANGUAGE plpgsql SECURITY DEFINER;
